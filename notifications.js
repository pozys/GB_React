function notifications(window) {
  ...
  const activeNotification = document.querySelector(".activeNotification")
  const inActiveNotification = document.querySelector(".inActiveNotification")
  ...
  function changePushStatus(status) {
    ...
    if (status) {
      ...
      inActiveNotification.classList.add("invisible")
      activeNotification.classList.remove("invisible")
    } else {
      pushElement.classList.remove("active")
      inActiveNotification.classList.remove("invisible")
      activeNotification.classList.add("invisible")
    }
  }
